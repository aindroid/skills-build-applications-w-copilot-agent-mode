...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Activity.objects.create(user='Captain America', type='cycle', duration=45, date='2025-12-01')
        Activity.objects.create(user='Batman', type='swim', duration=25, date='2025-12-01')
        Activity.objects.create(user='Superman', type='fly', duration=60, date='2025-12-01')
        ...
        self.stdout.write(self.style.SUCCESS('Test data populated for octofit_db.'))
